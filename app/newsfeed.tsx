...
const FeedItem = ({ post, currentUserId, onEdit, onDelete }: { post: any, currentUserId: number, onEdit: (post: any) => void, onDelete: (id: number) => void }) => {
    // Có thể check quyền ở đây, tạm thời auto cho phép sửa/xóa nếu là bài của mình.
    // Lấy ID user_id từ gốc, hoặc auth admin. Tạm giả định post.author = user.name
    return (
        <View style={styles.postCard}>
            <View style={styles.postHeader}>
                ...
                {/* Check xem có phải bài mình ko, tạm show với tất cả demo */}
